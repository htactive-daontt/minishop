...
@section('src-header-admin')
    <!-- Timeline CSS -->
    <link href="{{$urlAdmin}}/css/timeline.css" rel="stylesheet">
    <!-- Morris Charts CSS -->
    <link href="{{$urlAdmin}}/css/morris.css" rel="stylesheet">
@endsection
{{--content--}}
                ...
                @if( isset($arCount) )
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-primary">
                            ...
                            <a href="{{route('admin.products.get')}}">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-yellow">
                            ...
                            <a href="{{route('admin.transactions.get')}}">
                                <div class="panel-footer">
                                    <span class="pull-left">Xem chi tiết</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
...
@section('src-footer-admin')
    ...
    <script src="{{$urlAdmin}}/js/raphael.min.js"></script>
    <script src="{{$urlAdmin}}/js/morris.min.js"></script>
    <script src="{{$urlAdmin}}/js/morris-data.js"></script>
@endsection
