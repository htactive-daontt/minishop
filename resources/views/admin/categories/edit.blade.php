                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" action="{{route('admin.categories.postUpdate',$dataOfUpdate['objectEdit']->id)}}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            <label>Tên danh mục</label>
                                            <input class="form-control" name="editnamecat" value="{{$dataOfUpdate['objectEdit']->name}}">
                                        ...
                                        @if(isset($dataOfUpdate['categories']))
                                            <div class="form-group">
                                                <label>Danh mục cha</label>
                                                <select class="form-control" name="editidsub">
                                                    <option value="0">--Không--</option>
                                                    @foreach($dataOfUpdate['categories'] as $value)
                                                        @php $active = ''; @endphp
                                                        @if( $value->id == $dataOfUpdate['objectEdit']->parent_id )
                                                            @php
                                                                $active ='selected=""';
                                                            @endphp
                                                        @endif
